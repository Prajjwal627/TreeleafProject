...
import com.OneToOne.OTO.exception.ResourceNotFoundException;
...
public class LaptopController {
    ...
    @PostMapping
    public Laptop createLaptop(@Valid @RequestBody Laptop lp) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Laptop> updateLaptop(@PathVariable long id, @Valid@RequestBody Laptop laptopDetails) {
